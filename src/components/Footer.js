    ...
    <>
      <div>
        <footer className="bg-theme-700 mt-2 border-t border-theme-default bg-black">
          ...
          <div className="container px-4 pt-6 text-white mt-2">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-9 ">
              ...
              <ul className="space-y-4 text-xl">
                ...
                <div className="space-y-1 text-gray-400">
                  <div className="flex items-center gap-4">
                    <EnvelopeSimple size={32} color="#61c06a" />
                  ...
                  <div className="flex items-center gap-4">
                    <a
                      ...
                      rel="noreferrer"
                    >
                      <FacebookLogo size={32} color="#61c06a" />
                    </a>
                    <a
                      ...
                      rel="noreferrer"
                    >
                      <LinkedinLogo size={32} color="#61c06a" />
                    </a>
                  </div>
                </div>
              </ul>
              <ul className="space-y-4 ">
                ...
                <div className="flex text-xl gap-4 text-gray-400">
                  ...
                  #01, Ground Floor, Pinnac Apt., Vakil Nagar, Erandwane, Pune -
                  411004
                </div>
              </ul>
            </div>
