...
function WhoWeAre() {
  return (
    <section className="container px-4 mx-auto mt-32">
      <div className="text-lg text-theme-dark font-semibold">WHO WE ARE</div>
      <div className="flex flex-row mt-3 max-w-2xl">
        <div className="text-4xl text-theme-dark  ">
          ...
          <p className="text-3xl text-theme-dark  font-semibold">
            Offers Experts & innovative Renewable Energy Solutions tailored for
            Commercial, Industrial and Residential segments.
          </p>
        </div>
      </div>
