...
function page() {
  const tabs = [
    ...
    },
    {
      ...
      title: "Environment Management Systems (EMS)",
      image: "/Images/I-M-S/environmental-management.jpg",
      description:
        "Environmental management focuses on minimizing the environmental impact of solar plant projects. This includes strategies to reduce carbon footprint, minimize waste generation, and ensure responsible sourcing of materials. Engineers and project managers implement environmentally friendly practices to contribute to sustainable and eco-friendly energy solutions.",
    },
    {
  ...
  return (
    <div className="container my-24 mx-auto p-5">
      <div className="text-4xl md:text-5xl  text-left">
        ...
        <span className="text-theme-default">Management System (IMS)</span>
      </div>
      ...
      <p className="text-lg text-left mb-8">
        V-TECH Renewables facilitates IMS services for certifications of ISO
        9001:2015, ISO 14001:2015, ISO 45001:2018. An Integrated Management
        System (IMS) consolidates quality, environmental, health and safety,
        risk, compliance, and other management standards into a unified
        framework. It improves efficiency, reduces costs, ensures compliance,
        enhances stakeholder confidence, and promotes continuous improvement
        across an organization, fostering resilience and sustainable growth. IMS
        implementation involves planning, documentation, training, integration,
        monitoring, and continuous refinement to align with organizational goals
