          ...
          <div className="container p-5 m-auto flex items-end h-full w-full">
            <div className="text-white space-y-3 md:space-y-5">
              <div className="text-4xl md:text-5xl  md:max-w-4xl ">
                <span className="text-black font-black ">Open Access</span>{" "}
                <span className="text-theme-default">(Group Captive)</span>
              </div>
              ...
              <p className="text-lg text-black text-left mb-8">
                At V-TECH Renewables, we are passionate about encouraging the
                use of renewable energy sources by developing cutting-edge Open
                Access Group Captive Solar models. Our goal is to help
                businesses achieve their growth and sustainability objectives by
                offering them dependable, affordable, and eco-friendly solar
                energy solutions.
              </p>
            </div>
          </div>
      ...
      <div className="container  mx-auto p-5">
        ...
        <ul className=" text-lg text-left mb-8">
          ...
          <li className="flex items-center gap-4">
            ...
            <span>
              Waiver of 'Cross-subsidy surcharge' on minimal 26% capital
              investment.
            </span>
          </li>
          <li className="flex items-center gap-4">
            ...
            <span>
              Waiver of additional surcharge under 'Captive' and 'Group Captive'
              models.
            </span>
          </li>
          <li className="flex items-center gap-4">
            ...
            <span>
              No technical expertise required for complete energy transition.
            </span>
          </li>
          <li className="flex items-center gap-4">
            <div className="p-1 bg-gradient-to-r from-[#61c06a] to-[#549b9b] rounded-full flex items-center justify-center">
            ...
            <span>Bulk power consumers can meet 70-80% of energy from RE.</span>
          </li>
        </ul>
        <div className="bg-gradient-to-r from-[#61c06a] to-[#549b9b] inline-block text-transparent bg-clip-text text-3xl font-black my-5">
