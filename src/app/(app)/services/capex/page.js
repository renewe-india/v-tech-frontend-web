  ...
  const data = [
    {
      ...
      items: [
        "In a CAPEX model, the business or property owner makes an upfront investment to purchase the solar panels, inverters, mounting structures, and other necessary equipment.",
          ...
          <div className="container p-5 m-auto flex items-end h-full w-full">
            <div className="text-white space-y-3 md:space-y-5">
              <div className="text-4xl md:text-5xl  text-left">
                <span className="text-black font-black">Capex </span>{" "}
              ...
              <p className="text-lg text-black text-left mb-8">
                V-TECH Renewables committed to providing cutting-edge renewable
                energy solutions that are both efficient and sustainable. With a
                mission to harness the power of the sun to meet the growing
                energy needs of businesses and homeowners, we offer a wide range
                of services designed to maximize energy output and reduce carbon
                footprints.
              </p>
            </div>
          </div>
