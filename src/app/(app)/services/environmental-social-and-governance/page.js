          ...
          <div className="container p-5 m-auto flex items-end h-full w-full">
            <div className="text-white space-y-3 md:space-y-5">
              <div className="text-4xl md:text-5xl  text-left ">
                <span className="text-black font-black"> Environmental,</span>{" "}
              ...
              <p className="text-lg text-black text-left mb-8">
                V-TECH Renewables provides Environmental, Social, and Governance
                (ESG) services (including social impact analysis, and associated
                risk management) tailored for the Renewables Energy sector. Our
                comprehensive ESG solutions help businesses and organizations
                enhance their sustainability practices, ensure regulatory
                compliance, and improve their overall ESG performance. By
                partnering with us, you can demonstrate your commitment to
                responsible business practices while achieving your
      ...
      <div className="container mx-auto p-5 -mt-32">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 justify-center items-stretch">
          {data.map((item) => (
            <div
              key={item.title}
              className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center h-full relative"
            >
