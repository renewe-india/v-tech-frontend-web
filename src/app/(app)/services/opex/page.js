      ...
      <div className=" flex flex-col lg:flex-row lg:gap-32  items-start justify-centers ">
        <div className="lg:w-2/5 w-full mb-8 lg:mb-0">
          ...
          <p className="text-lg  text-left mb-8">
            V-TECH Renewables specializes in providing sustainable and
            cost-effective solar energy solutions. Our focus is on rooftop solar
            installations using an operating expense (Opex) model, enabling
            businesses and homeowners to harness the power of solar energy
            without the burden of upfront capital costs.
          </p>
        </div>
              ...
              <div className="flex-grow">
                ...
                <ul className="mt-3 mx-5 list-disc">
                  <li className="flex items-start  gap-4 mt-2">
                    ...
                    The consumer provides the space, and the developer invests
                    in the equipment, installation, commissioning, and
                  ...
                  <li className="flex items-start  gap-4 mt-2">
                    ...
                    The customer pays for the power generated under a long-term
                    power purchase agreement (PPA) for a fixed tenure at an
                    agreed tariff.
                  </li>
                  <li className="flex items-start  gap-4 mt-2">
                    <div className="p-1 mt-1 bg-gradient-to-r from-[#61c06a] to-[#549b9b] rounded-full flex items-center justify-center">
                    ...
                    The capital is repaid through generated electricity.
                  </li>
                </ul>
              </div>
            </div>
