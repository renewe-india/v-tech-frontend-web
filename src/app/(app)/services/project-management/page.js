      ...
      <div className="flex flex-col lg:flex-row lg:gap-32 items-start justify-center">
        <div className="lg:w-1/3 w-full mb-8 lg:mb-0">
          <div className="text-4xl md:text-5xl  text-left ">
            <span className="text-black font-black"> Project</span>{" "}
          ...
          <p className="text-lg text-left mb-8">
            V-TECH Renewables offers comprehensive Solar Project Management
            services that ensure the successful execution of your solar energy
            projects from concept to completion. Our expert team oversees every
            aspect of the project lifecycle, guaranteeing efficiency, quality,
            and timely delivery.
          </p>
        </div>
